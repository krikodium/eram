...
def main():
    ...
    print("INICIANDO ANALISIS COMPLETO DE FOTOS")
    print("=" * 50)
    ...
    print("\nAnalizando archivos en Supabase Storage...")
    try:
    ...
    for i, producto in enumerate(productos_sin_imagen[:10]):
        ...
        status = "OK - Tiene foto en Drive" if tiene_foto else "NO - No tiene foto en Drive"
